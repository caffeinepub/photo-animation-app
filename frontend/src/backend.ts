...
import type { ExternalBlob as _ExternalBlob, PhotoId as _PhotoId, PhotoRecord as _PhotoRecord, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async consumeCredit(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.consumeCredit();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCreditStatus(): Promise<Credits> {
        if (this.processError) {
            try {
                const result = await this.actor.getCreditStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhoto(arg0: string): Promise<PhotoRecord | null> {
        if (this.processError) {
            try {
    ...
    async getPhotoBlob(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoBlob(arg0);
    ...
    async uploadPhoto(arg0: string, arg1: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(arg0, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PhotoRecord_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoRecord): Promise<PhotoRecord> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PhotoRecord]): Promise<PhotoRecord | null> {
    return value.length === 0 ? null : await from_candid_PhotoRecord_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoRecord>): Promise<Array<PhotoRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoRecord_n14(_uploadFile, _downloadFile, x)));
}
